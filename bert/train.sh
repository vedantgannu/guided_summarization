...
python z_train.py  -task abs -mode train -bert_data_path $DATA_PATH -dec_dropout 0.2  -model_path $MODEL_PATH -sep_optim true -lr_bert 0.002 -lr_dec 0.2 -save_checkpoint_steps 1 -batch_size 140 -train_steps 11 -report_every 1 -accum_count 2 -use_bert_emb true -use_interval true -warmup_steps_bert 10 -warmup_steps_dec 10 -max_pos 512 -visible_gpus 0  -log_file $LOG_PATH
