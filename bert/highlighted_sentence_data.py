# Change directory into the bert_data_cnndm_final directory
# cd bert_data_cnndm_final
# python ../highlighted_sentence_data.py ../highlighted_sentence_data_dir train
